...
$MESS['INCORRECT_INTEGER_VALUE'] = 'Incorrect value for field: #INPUT#. Only an integer numeric value is allowed.';
...
$MESS['YML_CHUNK_SIZE'] = 'Number of items to upload in one step';
$MESS['CLIENTS'] = 'Clients settings';
