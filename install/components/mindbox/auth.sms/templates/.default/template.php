...
<div class="mindbox">
    ...
    <form id="mindbox-input-phone" action="" class="form form-default">
        <div class="row form-group">
            <div class="col col-md-12">
                ...
                <div>
                    <input type="text" class="form-control js-mask" name="mindbox-num" id="mindbox-num" data-type="phone">
                </div>
            </div>
        </div>
            ...
            <div class="col col-md-8">
                <div class="form-inline-elements">
                    ...
                    <button type="button" class="btn btn-auth js-auth-code" id="mindbox-submit-code--resend">
                        <span class="js-auth-code-text"><?=GetMessage('MB_AUS_RESEND_BUTTON')?></span> <span class="js-auth-code-timer"></span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col col-md-8 col-md-offset-3">
                <div class="form-inline-elements">
                    ...
                    <button type="button" class="btn" id="mindbox-submit-code--reset"><?=GetMessage('MB_AUS_RESET_BUTTON')?></button>
                </div>
            </div>
        </div>
    </form>
    ...
    <form id="mindbox-fillup-profile" action="" class="form-horizontal form-default" style="display: none">
        <div class="form-group">
            <div class="col col-md-4">
                <label for="mindbox-fillup-name" class="control-label"><?=GetMessage('MB_AUS_FIRST_NAME')?></label>
            </div>
        ...
        <div class="form-group">
            <div class="col col-md-4">
                <label for="mindbox-fillup-last-name" class="control-label"><?=GetMessage('MB_AUS_LAST_NAME')?></label>
            </div>

            <div class="col col-md-8">
                <input type="text" class="form-control" name="mindbox-fillup-last-name" id="mindbox-fillup-last-name">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col col-md-8">
                <input type="text" class="form-control js-mask" name="mindbox-fillup-email" id="mindbox-fillup-email" data-type="email" required>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col col-md-8">
                <input type="text" class="form-control js-mask" name="mindbox-fillup-phone" id="mindbox-fillup-phone" data-type="phone" readonly>
            </div>
        ...
        <div class="form-group">
            <div class="col col-md-4">
                <label for="mindbox-fillup-password" class="control-label"><?=GetMessage('MB_AUS_PASSWORD')?></label>
            </div>

            <div class="col col-md-8">
                <input type="password" class="form-control" name="mindbox-fillup-password" id="mindbox-fillup-password" required>
            </div>
        </div>

        <div class="form-group">
            <div class="col col-md-4">
                <label for="mindbox-fillup-date" class="control-label"><?=GetMessage('MB_AUS_BIRTH_DATE')?></label>
            </div>

            <div class="col col-md-8">
                <input type="text" class="form-control js-mask" name="mindbox-fillup-date" id="mindbox-fillup-date" data-type="date">
            </div>
        ...
        <?php if($arResult["USE_CAPTCHA"] == "Y"): ?>
            <div class="form-group">
                ...
                <div class="col col-md-8">
                    <input type="hidden" name="captcha_sid" id="mindbox--captcha_sid" value="<?=$arResult["CAPTCHA_CODE"]?>" />
                    <img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["CAPTCHA_CODE"]?>" id="mindbox--captcha_img" width="180" height="40" alt="CAPTCHA" />
                </div>
            </div>

            <div class="form-group">
                <div class="col col-md-4">
                    <label for="mindbox--captcha_word" class="control-label"><?=GetMessage('MB_AUS_CAPTCHA_PROMPT')?></label>
                </div>
